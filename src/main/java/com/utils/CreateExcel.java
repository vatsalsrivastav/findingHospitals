...
public class CreateExcel {
	...
	/*
	 * This method is used to generate an excel file that contains the names of
	 * the hospitals and their respective star rating.
	 */
	public static void generateReport(Map<String, String> hospList)
			throws IOException {
		...
		for (Map.Entry<String, String> m : hospList.entrySet()) {
			details.put(Integer.toString(i), new Object[] { (i - 1),
					m.getKey(), m.getValue()});
			i++;
		}
		...
		try {
			...
			// Printing confirmation message that the excel file has been
